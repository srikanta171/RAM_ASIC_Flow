...
#  Created on Wed Dec 20 19:17:07 2023                
#                                                     
#######################################################
...
set init_verilog ../synthesis/ram_netlist.v
set init_mmmc_file viewDefinition.tcl
set init_io_file ram_iopad.io
set init_pwr_net {VDD VDDO}
init_design
fit
getIoFlowFlag
setIoFlowFlag 0
floorPlan -site CoreSite -d 1455.0 1455.0 20 20 20 20
uiSetTool select
getIoFlowFlag
fit
setIoFlowFlag 0
floorPlan -site CoreSite -d 1454.88 1454.88 20.16 20.16 20.16 20.16
uiSetTool select
getIoFlowFlag
fit
selectInst dataIO3
